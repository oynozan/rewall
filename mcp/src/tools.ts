/*
 * The Rewall tools themselves, SPEC section 7
 ...
 * Shared by both entry points, src/index.ts over stdio and src/http.ts over the network
 */
...
export const INSTRUCTIONS = `Rewall holds this user's credentials. You can use them without ever seeing them.
