...
/*
 * Raymarched wave backdrop, vendored from react-bits rather than pulled through the shadcn CLI, which
 ...
 * motion guard that renders one still frame instead of running a loop, and a pointer transparent
 * root, since the waves sit behind live copy.
 * Source https://reactbits.dev/r/GradientWaves-TS-TW.json
 */
