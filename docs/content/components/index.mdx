...
The dashboard and the MCP server install the SDK from npm as `@rewall/sdk`. The folders developed
alongside it link it from the repo instead and import its built `dist` folder. The SDK talks to
