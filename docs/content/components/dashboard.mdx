...
where you store secrets, share them by ENS name, take them back, hold 2FA accounts and send private
payments. Recovering a lost wallet is done with the [SDK](/components/sdk).
