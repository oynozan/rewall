...
It ships as ES modules with its own types, and carries viem, libsodium and otpauth as dependencies,
so nothing else has to be installed alongside it. To work on the SDK itself rather than build against
it, clone the repo and follow [Building and testing](#building-and-testing).
